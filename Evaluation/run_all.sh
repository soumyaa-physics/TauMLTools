...
# python plot_roc.py path_to_mlflow=../Training/python/distautag/mlruns experiment_id=${EXP_ID} vs_type=jet 'bin.jet_pt=[20, 50]' 'bin.jet_eta=[-2.3, 2.3]' 'bin.Lrel=[0.0, 5.0]' 
...
# python plot_roc.py path_to_mlflow=../Training/python/distautag/mlruns experiment_id=${EXP_ID} vs_type=jet 'bin.jet_pt=[50, 100]' 'bin.jet_eta=[-2.3, 2.3]' 'bin.Lrel=[0.0, 5.0]' 
...
# python plot_roc.py path_to_mlflow=../Training/python/distautag/mlruns experiment_id=${EXP_ID} vs_type=jet 'bin.jet_pt=[100, 1000]' 'bin.jet_eta=[-2.3, 2.3]' 'bin.Lrel=[0.0, 5.0]' 
...
# python plot_roc.py path_to_mlflow=../Training/python/distautag/mlruns experiment_id=${EXP_ID} vs_type=jet 'bin.jet_pt=[20, 1000]' 'bin.jet_eta=[-2.3, 2.3]' 'bin.Lrel=[0.0, 5.0]'
